...
public class HackathonV2Page {
  ...
  private static final Logger log = LoggerFactory.getLogger(HackathonV2Page.class.getName());
  ...
  public List<String> getListedBlackProductDomIds() {
    ...
    listedBlackProductDomIds.add(blackFilteredProducts.get("blackProduct1ImageLink").getAsString());
    ...
    listedBlackProductDomIds.add(blackFilteredProducts.get("blackProduct2ImageLink").getAsString());
  ...
  public void clickFirstProduct() {
    ...
    clickElement(products.get("product1ImageLink").getAsString());
  }
}
